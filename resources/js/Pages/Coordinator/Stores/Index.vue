...
const submitImport = () => {
    importForm.post(route('coordinator.stores.import-csv'), {
        onSuccess: () => {
...
const filteredStores = computed(() => {
    return props.stores.filter((s) => {
        ...
        const matchesType = !typeFilter.value || (s.type || 'TOKO') === typeFilter.value;
...
const deleteStore = (store) => {
    openConfirm({
        ...
        type: 'danger',
        action: () => router.delete(route('coordinator.stores.destroy', store.id)),
    });
};
</script>

<template>
    <AppLayout title="Data Toko & Gudang (CSA)">
        <Head title="Manajemen Unit Toko & CSA — Koordinator" />
        ...
        <div class="mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            ...
            <div class="flex items-center flex-wrap gap-2 sm:gap-2.5">
                ...
                <Link
                    :href="route('coordinator.stores.create')"
                ...
                >
                    ...
                    <div class="pt-2 flex items-center justify-between border-t border-gray-100">
                        ...
                        <div class="flex items-center gap-2">
                            <Link
                                :href="route('coordinator.stores.edit', s.id)"
