...
<template>
    <AppLayout :title="`Edit Audit - ${audit.audit_number}`">
        <Head :title="`Edit Audit - ${audit.audit_number} — Admin`" />
        ...
        <div class="mb-6">
            ...
            <p class="text-xs text-gray-500 mt-1">Perbarui kategori audit, unit toko/badan usaha, dan tim auditor bertugas.</p>
        </div>
