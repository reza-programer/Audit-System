...
const promptSaveRecommendation = () => {
    openConfirm({
        ...
        type: 'primary',
        action: () => {
            recommendationForm.patch(route('admin.findings.recommendation.update', props.finding.id), {
                preserveScroll: true,
                onSuccess: () => {
...
// Form Review Severity (Admin / Chief)
        ...
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <div class="flex items-center gap-2 text-xs text-gray-500 mb-1">
                    ...
                    <span>/</span>
                    <Link :href="route('admin.audits.show', finding.audit.id)" class="hover:text-blue-600 font-mono">{{ finding.audit.audit_number }}</Link>
                    <span>/</span>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-5 shadow-xs space-y-4">
                    ...
                    <form @submit.prevent="submitSeverityReview" class="space-y-3 pt-1">
                        ...
                        <div>
                            <label class="block font-medium text-gray-700 mb-1">Catatan Review (Opsional)</label>
                            <textarea
